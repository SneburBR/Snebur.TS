# `<sn-progresso>` — Progress bar

**Type:** Form control (`sn-`) | **Class:** `Progresso` | **Extends:** `BaseControle` | **Rendered as:** `HTMLDivElement`
...
Extracted from the Sigi frontend (8 usages in 6 files).
...
<sn-progresso
        ...
        ap-altura="12px"
        sn-bind-progresso="{{Progresso}}">
    </sn-progresso>
```

*Source: `src/frontend/Zyoncore.Sigi.FotoAlbum.TS/Apresentacao/Montagem/MenuItens/Fotos/JanelaFotosPendente.shtml`*

```html
<sn-progresso sn-nome="ControleProgresso" sn-bind="{{Progresso}}, Origem=this" >
    </sn-progresso>
```

*Source: `src/frontend/Zyoncore.Sigi.Online/Apresentacao/Principal/Montagem/JanelaConcluirMontagem.shtml`*

```html
<sn-progresso sn-bind="{{Progresso}}" ap-altura="16px">
    </sn-progresso>
```

*Source: `src/frontend/Zyoncore.Sigi.Online/Apresentacao/Principal/Envio/JanelaProgressoEnvio.shtml`*
...
`Progresso` → `BaseControle` → `ComponenteApresentacaoConteudo` → `ComponenteApresentacao` → `BaseUIElemento`

## Usage in Sigi

Found **8** usages across **6** `.shtml` files in the Sigi frontend.
