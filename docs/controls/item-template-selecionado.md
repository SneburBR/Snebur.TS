# `<sn-item-template-selecionado>` — Selected-item template

**Type:** Form control (`sn-`) | **Class:** `ItemTemplateSelecionado` | **Extends:** `BaseTemplate` | **Rendered as:** `HTMLDivElement`

> Also registered as: `<sn-item-selecionado-template>`

Alternative template rendered for the currently selected item of a list/selection control.

## Real-world examples

Extracted from the Sigi frontend (10 usages in 3 files).

```html
<sn-item-template-selecionado ap-altura-linha="25px">
        <ap-texto sn-bind="{{Nome}}"></ap-texto>
    </sn-item-template-selecionado>
```

*Source: `src/frontend/Zyoncore.Sigi.WebAdmin/Apresentacao/Encadernacao/Relacionamentos/Album/Capa/Relacionamentos/02_AcabamentoPapel/ControleAcabamentosPapelCapaSuportado.shtml`*
...
<sn-item-template-selecionado>
        ...
        <ap-painel ap-tipo-painel="PilhaHorizontal">
            ...
            <ap-bloco>
                <ap-texto ap-margem="2px 0px" ap-largura="12px"
            ...
            <ap-bloco>
                <ap-icone
                    sn-nome="IconeEspacamentoVertical"
                    sn-tipo-botao="Icone"
                    ap-cor-fundo="Branca"
                    ap-icone="FormatLineSpacing">
                </ap-icone>
            </ap-bloco>
...
<sn-item-template-selecionado>
        ...
        <ap-painel ap-tipo-painel="PilhaHorizontal">
            ...
            <ap-bloco>
                <ap-texto ap-margem="2px 0px" ap-largura="12px"
                    ap-tipografia="BotaoCaixaAlta" sn-bind="{{.}}">
                </ap-texto>
            </ap-bloco>
            <ap-bloco>
                <ap-icone
                    sn-nome="IconeEspacamentoHorizontal"
                    sn-tipo-botao="Icone"
                    ap-cor-fundo="Branca"
                    ap-icone="FormatLineSpacing"
                    class="sn-icone-90">
...
`ItemTemplateSelecionado` → `BaseTemplate` → `BaseControle` → `ComponenteApresentacaoConteudo` → `ComponenteApresentacao` → `BaseUIElemento`

## Usage in Sigi

Found **10** usages across **3** `.shtml` files in the Sigi frontend.
