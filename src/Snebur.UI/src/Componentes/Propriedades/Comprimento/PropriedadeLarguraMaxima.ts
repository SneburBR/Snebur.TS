namespace Snebur.UI
{
    export class PropriedadeLarguraMaxima extends BasePropriedadeComprimento
    {

        public readonly ProprieadesEstiloDom: string[] = ["max-width"];

        public constructor()
        {
            super(AtributosHtml.LarguraMaximaApresentacao);
        }
