namespace Snebur.UI
{
    export class Estilo  /*implements CSSStyleDeclaration*/
    {
        accentColor: string;
        alignContent: string;
        alignItems: string;
        ...
        public constructor(inicializador?: Partial<Estilo>)
        {
            ...
            {
                Object.assign(this, inicializador);
            }
        }

        public Masclar(estilo: Estilo)
        {
            for (const propriedade in estilo)
            {
                if (typeof propriedade !== "undefined")
                {
                    ...
                    //{
                        if ((this as any)[propriedade] !== (estilo as any)[propriedade])
                        {
                            (this as any)[propriedade] = (estilo as any)[propriedade];
                        }
                    //}
                    /*eslint-enable*/
                }
        ...
        public AplicarEm(elemento: HTMLElement | Element): void
        {
            EstiloUtil.AtualizarEstilo(elemento, this);
        }

        public toString()
        {
            const sb = new StringBuilder();
            sb.AppendLine("new Estilo({");
