namespace Snebur.UI
{
    export class MascaraDecimal extends BaseMascara
    {
        ...
        public override RetornarValorFormatado(valorDom: string): string
        {
            ...
            return u.FormatacaoUtil.Formatar(ConverterUtil.ParaNumero(valorDom), this.FormataMascara);
        }
        //#endregion
        ...
        private FormatarValorDomComFocus(value: string): string
        {
            ...
            return FormatacaoUtil.Formatar(ConverterUtil.ParaNumero(value), this.FormataMascara);
        }
