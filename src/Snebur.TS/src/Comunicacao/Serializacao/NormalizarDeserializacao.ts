...
////            for (let baseNegocioRefernciada of this.BasesDominioReferenciadas)
////            {
...
////                }
////                let baseOrigem = this.BasesDominioOrigem.Item(baseNegocioRefernciada.IdentificadorReferencia);
...
////                let objetoPai = referencia.ObjetoPai;
...
////            {
////                throw new Erro("Falha ao preparar objeto para serialização, o numero maximo de analise foi atingido");
////            }
...
////                    let tipoItem = colecao[0].GetType();
...
////            {
////                for (let chave of objeto.Chaves)
////                {
////                    let item = objeto.Item(chave);
////                    if (this.IsBaseDominio(item))
////                    {
...
////            else
////            {
////                let propriedades = JsonUtil.RetornarPropriedadesSerializavel(tipo, false);
////                for (let proprieade of propriedades)
////                {
////                    let item = proprieade.RetornarValor(objeto);
...
////        {
////            let referenciaPropriedade = new ReferenciaPropriedade({
////                ObjetoPai: objeto,
...
////        {
////            let referenciaColecao = new ReferenciaDicionario({
...
////        {
////            let referenciaColecao = new ReferenciaColecao({
////                Colecao: colecao,
////                Posicao: posicao
////            });
////            this.AdicioanrReferencia(baseDominio, referenciaColecao);
