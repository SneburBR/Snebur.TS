namespace Snebur.Utilidade
{
    export class ImagemUtil
    {
        ...
        public static InicializarImagem(imagem: d.IImagem, arquivo: SnBlob, info: IInformacaoImagem): void
        {
            ...
            {
                const mimeType = this.RetornarMimeTypeEnum(info.FormatoImagem);
                ...
                imagem.DimensaoImagemMiniatura = new Dimensao(u.ImagemUtil.RetornarDimensagemImagem(info.Dimensao, d.EnumTamanhoImagem.Miniatura));
                imagem.DimensaoImagemPequena = new Dimensao(u.ImagemUtil.RetornarDimensagemImagem(info.Dimensao, d.EnumTamanhoImagem.Pequena));
                imagem.DimensaoImagemMedia = new Dimensao(u.ImagemUtil.RetornarDimensagemImagem(info.Dimensao, d.EnumTamanhoImagem.Media));
                imagem.DimensaoImagemGrande = new Dimensao(u.ImagemUtil.RetornarDimensagemImagem(info.Dimensao, d.EnumTamanhoImagem.Grande));
                imagem.FormatoImagem = info.FormatoImagem;
        ...
        public static RetornarDimensagemImagem(dimensao: IDimensao, tamanahoImagem: d.EnumTamanhoImagem): Dimensao
        public static RetornarDimensagemImagem(larguraImagem: number, alturaImagem: number, tamanahoImagem: d.EnumTamanhoImagem): Dimensao

        public static RetornarDimensagemImagem(argumento: any, argumento2: any, argumento3?: any): Dimensao
        {
            const dimensao = argumento instanceof d.Dimensao ? argumento : new d.Dimensao(argumento, argumento2);
            const tamanhoImagem: d.EnumTamanhoImagem = argumento instanceof d.Dimensao ? argumento2 : argumento3;
            const larguraImagem = dimensao.Largura;
            const alturaImagem = dimensao.Altura;
        ...
        private static RetornarMimeTypeEnum(formatoImagem: d.EnumFormatoImagem): EnumMimeType
        {
        ...
        public static IsFormatoSuportado(arquivoOuPath: string | SnBlob | Blob): boolean
        {
