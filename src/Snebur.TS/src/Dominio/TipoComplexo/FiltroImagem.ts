namespace Snebur.Dominio
{
    export class FiltroImagem extends BaseTipoComplexo
    {
        ...
        public set Exposicao(value: number)
        {
            if (value !== null)
            {
                u.ValidacaoUtil.ValidarIntervalo(value, -100, 100, "Exposi��o");
            }
        ...
        public readonly EventoAjusteAlterado = new Evento(this);
        ...
        private NotificarAjusteAlterado()
        {
            this.EventoAjusteAlterado.Notificar(this, EventArgs.Empty);
        }
