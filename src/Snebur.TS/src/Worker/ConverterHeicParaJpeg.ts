namespace Snebur.WebWorker
{
    export class ConverterHeicParaJpeg extends WorkerCliente<IMensagemConverterHeicParaJpeg, Blob | Error>
    {
        ...
        public static RetornarBufferAsync(arquivo: SnBlob, qualidade: number = u.ImagemUtil.QUALIDADE_APRESENTACAO_CANVAS): Promise<ArrayBuffer | Error>
        {
            const mensagem = {
        ...
        public static RetornarBlobAsync(arquivo: SnBlob, qualidade: number = u.ImagemUtil.QUALIDADE_APRESENTACAO_CANVAS): Promise<Blob | Error>
        {
            const mensagem = {
                Arquivo: arquivo.Blob,
                Qualidade: qualidade
        ...
        public static RetornarUrlBlobAsync(arquivo: SnBlob, qualidade: number = u.ImagemUtil.QUALIDADE_APRESENTACAO_CANVAS): Promise<string | Error>
        {
            const mensagem = {
                Arquivo: arquivo.Blob,
                Qualidade: qualidade
