declare namespace MagickWasm
{
    ...
    type ByteArray = Int8Array | Uint8Array | Uint8ClampedArray;
    ...
    type MagickFormat = typeof MagickFormat[keyof typeof MagickFormat];
    interface IDefine
    {
    ...
    type Gravity = typeof Gravity[keyof typeof Gravity];
    interface IMagickColor
    {
        r: number;
        g: number;
        b: number;
    ...
    class MagickColor implements IMagickColor
    {
    ...
    type PaintMethod = typeof PaintMethod[keyof typeof PaintMethod];
    const TextAlignment: {
        readonly Undefined: 0;
        readonly Left: 1;
        readonly Center: 2;
    ...
    type TextDecoration = typeof TextDecoration[keyof typeof TextDecoration];
    interface IDrawingWand extends IDisposable
    {
    ...
    interface IDrawableAffine extends IDrawable
    {
    ...
    class DrawableAffine implements IDrawableAffine
    {
        private _scaleX;
        private _scaleY;
        private _shearX;
    ...
    class DrawableBorderColor implements IDrawable
    {
    ...
    class DrawableFillRule implements IDrawable
    {
    ...
    class DrawableLine implements IDrawable
    {
    ...
    interface IPath extends IDrawable
    {
    }
    class DrawablePath implements IDrawable
    {
        private _paths;
        constructor(paths: IPath[]);
        draw(wand: IDrawingWand): void;
    }
    class DrawablePoint implements IDrawable
    {
        private readonly _x;
        private readonly _y;
    ...
    class DrawableStrokeColor implements IDrawable
    {
        private readonly _color;
        constructor(color: IMagickColor);
        get color(): IMagickColor;
    ...
    class DrawableStrokeDashArray implements IDrawable
    {
    ...
    class DrawableStrokeDashOffset implements IDrawable
    {
    ...
    class DrawableStrokeWidth implements IDrawable
    {
    ...
    class DrawableTextAlignment implements IDrawable
    {
    ...
    class DrawableTextAntiAlias implements IDrawable
    {
    ...
    class DrawableTextDecoration implements IDrawable
    {
    ...
    class DrawableTextInterlineSpacing implements IDrawable
    {
    ...
    class DrawableTextInterwordSpacing implements IDrawable
    {
        private readonly _spacing;
        constructor(spacing: number);
        get spacing(): number;
    ...
    class DrawableTextKerning implements IDrawable
    {
    ...
    class DrawableTextUnderColor implements IDrawable
    {
        private readonly _color;
        constructor(color: IMagickColor);
        get color(): IMagickColor;
    ...
    type AlphaAction = typeof AlphaAction[keyof typeof AlphaAction];
    const Channels: {
        readonly Undefined: 0;
        readonly Red: 1;
        readonly Gray: 1;
    ...
    type ComplexOperator = typeof ComplexOperator[keyof typeof ComplexOperator];
    ...
    type EvaluateOperator = typeof EvaluateOperator[keyof typeof EvaluateOperator];
    ...
    class MagickGeometry implements IMagickGeometry
    {
    ...
    type DensityUnit = typeof DensityUnit[keyof typeof DensityUnit];
    class Density
    {
    ...
    type Interlace = typeof Interlace[keyof typeof Interlace];
    ...
    type DitherMethod = typeof DitherMethod[keyof typeof DitherMethod];
    ...
    interface IMagickImageCollection extends Array<IMagickImage>, IDisposable
    {
    ...
    type AsyncImageCallback<TReturnType> = (image: IMagickImage) => Promise<TReturnType>;
    type SyncImageCallback<TReturnType> = (image: IMagickImage) => TReturnType;
    type ImageCallback<TReturnType> = (image: IMagickImage) => TReturnType | Promise<TReturnType>;
    type AsyncImageCollectionCallback<TReturnType> = (images: IMagickImageCollection) => Promise<TReturnType>;
    type SyncImageCollectionCallback<TReturnType> = (images: IMagickImageCollection) => TReturnType;
    type ImageCollectionCallback<TReturnType> = (images: IMagickImageCollection) => TReturnType | Promise<TReturnType>;
    ...
    type AutoThresholdMethod = typeof AutoThresholdMethod[keyof typeof AutoThresholdMethod];
    class PrimaryInfo
    {
    ...
    interface IColorProfile extends IImageProfile
    {
    ...
    class ColorProfile extends ImageProfile implements IColorProfile
    {
        private _data?;
    ...
    const ColorTransformMode: {
        readonly HighRes: 0;
        readonly Quantum: 1;
    };
    type ColorTransformMode = typeof ColorTransformMode[keyof typeof ColorTransformMode];
    class CompareResult
    {
        private constructor();
    ...
    type ErrorMetric = typeof ErrorMetric[keyof typeof ErrorMetric];
    ...
    type CompositeOperator = typeof CompositeOperator[keyof typeof CompositeOperator];
    class Point
    {
        constructor(xy: number);
        constructor(x: number, y: number);
    ...
    type DistortMethod = typeof DistortMethod[keyof typeof DistortMethod];
    ...
    const GifDisposeMethod: {
        readonly Undefined: 0;
        readonly None: 1;
        readonly Background: 2;
        readonly Previous: 3;
    };
    type GifDisposeMethod = typeof GifDisposeMethod[keyof typeof GifDisposeMethod];
    const Kernel: {
    ...
    type Kernel = typeof Kernel[keyof typeof Kernel];
    ...
    type MorphologyMethod = typeof MorphologyMethod[keyof typeof MorphologyMethod];
    ...
    type PixelChannel = typeof PixelChannel[keyof typeof PixelChannel];
    interface IChannelPerceptualHash
    {
    ...
    class ChannelPerceptualHash implements IChannelPerceptualHash
    {
    ...
    interface IPixelCollection extends IDisposable
    {
    ...
    type PixelIntensityMethod = typeof PixelIntensityMethod[keyof typeof PixelIntensityMethod];
    ...
    type PixelInterpolateMethod = typeof PixelInterpolateMethod[keyof typeof PixelInterpolateMethod];
    class ProgressEvent$1
    {
    ...
    type RenderingIntent = typeof RenderingIntent[keyof typeof RenderingIntent];
    ...
    type VirtualPixelMethod = typeof VirtualPixelMethod[keyof typeof VirtualPixelMethod];
    const MagickErrorSeverity: {
    ...
    type MagickErrorSeverity = typeof MagickErrorSeverity[keyof typeof MagickErrorSeverity];
    ...
    interface IMagickImage extends IDisposable
    {
    ...
    class PathLineToAbs implements IPath
    {
        private readonly _x;
        private readonly _y;
        constructor(x: number, y: number);
    ...
    class PathLineToRel implements IPath
    {
        private readonly _x;
        private readonly _y;
        constructor(x: number, y: number);
    ...
    class PathMoveToAbs implements IPath
    {
        private readonly _x;
        private readonly _y;
        constructor(x: number, y: number);
    ...
    class PathMoveToRel implements IPath
    {
        private readonly _x;
        private readonly _y;
        constructor(x: number, y: number);
    ...
    type LogEventTypes = typeof LogEventTypes[keyof typeof LogEventTypes];
    class LogEvent
    {
    ...
    class MagickImageInfo implements IMagickImageInfo
    {
        private _colorSpace;
